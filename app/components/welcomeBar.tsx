export default function WelcomeBar() {
 return (
  <>
   <div className="bg-[#5E6E66] rounded-xl p-6 text-white [&_strong]:font-semibold sm:[&_strong]:text-[24px] [&_strong]:text-[20px] mb-3 max-sm:text-sm [&_p]:font-normal [&_p]:text-[#FFFFFFCC]">
