...
export default function VirtualStep1({
 onBack,
 onNext,
}: {
 onBack: () => void;
  ...
  <>
   ...
   <div className="bg-[#FFFFFF] border border-[#D7DED3] rounded-xl p-6 [&_strong]:font-semibold [&_strong]:text-[20px] [&_strong]:text-[#2B3B33]">
    ...
    <div className="grid md:grid-cols-3 sm:grid-cols-2 sm:gap-4 space-y-4 [&_label]:text-sm [&>div]:flex [&>div]:flex-col [&>div]:gap-2">
     ...
     <div>
      <label htmlFor="form-visit">Patient Visit</label>
      <Select defaultValue="pc">
       <SelectTrigger id="form-visit">
        <SelectValue />
       </SelectTrigger>
       <SelectContent>
        <SelectItem value="pc">Phone Call</SelectItem>
        <SelectItem value="by">By Vsiting</SelectItem>
       </SelectContent>
      </Select>
     </div>
