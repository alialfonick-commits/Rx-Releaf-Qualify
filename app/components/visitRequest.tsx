...
export default function VisitRequest() {
    return (
     <>
      <div className="bg-[#5E6E66] rounded-xl p-6 text-white flex max-[992px]:flex-col items-center max-[992px]:items-start justify-between [&_strong]:font-semibold sm:[&_strong]:text-[24px] [&_strong]:text-[20px] mb-3 [&_p]:font-normal [&_p]:text-[#FFFFFFCC]">
