...
import Checkout from "./(with-sidebar)/(public)/patientDashboard/checkout";
import Thankyou from "./(with-sidebar)/(public)/patientDashboard/thankyou";
import ViewVisitDetails from "./components/viewVisitDetails";
import AdminLogin from "./(with-sidebar)/(dashboard)/adminDashboard/adminLogin";
      ...
      >
        ...
        <div className="bg-[#57746D] rounded-xl p-4 text-sm mt-4">
          ...
          <p className="text-[#FFFFFF99]">
            Contact support at
            <a
              href="mailto:admin@rxreleaf.com"
