...
export async function sendPaymentEmail(
  ...
  try {
    const response = await resend.emails.send({
      ...
      <img src="/logo.png" alt="logo" style="max-width: 130px;">
      </td>
      </tr>
      ...
      style="display:inline-block; padding-right: 36px !important; padding: 9px 13px; color: #FFFFFF; text-decoration: none; border-radius: 6px; font-weight:600; font-size: 14px; background: #D9A520 url(/next.png) right 12px center no-repeat; background-size: 17px;">Complete Payment</a>
      </div>
      ...
      <li
      style="padding-left: 25px; background: url(/icon\ \(1\).png) left center no-repeat; background-size: 17px; margin-bottom: 3px;">Single-use secure link</li>
      <li style="padding-left: 25px; background: url(/icon\ \(2\).png) left center no-repeat; background-size: 17px; margin-bottom: 3px;">Valid for 24 hours</li>
      <li style="padding-left: 25px; background: url(/icon\ \(3\).png) left center no-repeat; background-size: 17px;">Linked to your specific visit request</li>
      </ul>
      </div>
